...
def mean_diff_plot(m1, m2, sd_limit=1.96, ax=None, scatter_kwds=None,
                   mean_line_kwds=None, limit_lines_kwds=None, font_size=10, mae=None, axistitle_fontsize=15):
    ...
    anno = 'Mean difference:  {}'.format(np.round(mean_diff, 2))
    if mae:
    ...
    if sd_limit > 0:
        ...
        ax.annotate('{} SDs above mean: {}'.format(sd_limit, np.round(lower, 2)),
                    xy=(0.99, 0.07),
                    horizontalalignment='right',
                    verticalalignment='bottom',
                    fontsize=font_size,
                    xycoords='axes fraction')
        ax.annotate('{} SDs below mean: {}'.format(sd_limit, np.round(upper, 2)),
                    xy=(0.99, 0.92),
                    horizontalalignment='right',
                    fontsize=font_size,
                    xycoords='axes fraction')
    ...
    ax.set_ylabel('Difference (ms)', fontsize=axistitle_fontsize)
    ax.set_xlabel('Mean (ms)', fontsize=axistitle_fontsize)
